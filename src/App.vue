...
<template>
  ...
  <header class="bg-orange-200">
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="flex-1 md:flex md:items-center md:gap-12">
          <router-link class="block text-gray-800" to="/">
        ...
        <div class="md:flex md:items-center md:gap-12">
          ...
          <nav aria-label="Global" class="hidden md:block">
            <ul class="flex items-center gap-6 text-sm">
              ...
              <li>
                <router-link class="text-gray-500 transition hover:text-gray-500/75"to="/add"> Add an Individual Contact </router-link>
              </li>
              <li>
    ...
    <!-- BODY -->
    <main class="max-w-10xl mt-32 px-4 mx-auto"> 
