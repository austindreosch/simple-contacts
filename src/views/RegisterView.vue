...
<template>
  ...
  <section class="pt-10">
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-3/4 xl:col-span-6">
        <img
          alt=""
      ...
      <main
        class="flex justify-center px-8 py-1 sm:px-12 lg:col-span-7 lg:px-16 lg:py-2 xl:col-span-6 mt-28"
      >
